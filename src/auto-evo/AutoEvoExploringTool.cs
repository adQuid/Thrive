...
public class AutoEvoExploringTool : NodeWithInput
{
    ...
    {
        finishXGenerationsButton.Text = "Generations: " + Math.Round(value);
    ...
    private void ApplyAutoEvoRun()
    {
        ...
        speciesHistoryList.Add(
            gameProperties.GameWorld.worldSpecies.ToDictionary(pair => pair.Key, pair => (Species)pair.Value.Clone()));
