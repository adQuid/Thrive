...
public abstract class SelectionPressure
{
    ...
    public static List<Miche> MichesForPatch(Patch patch, PartList partList, SimulationCache cache)
    {
        ...
        {
            retval.Add(new Miche(pressure.Name(), pressure, new List<Miche> { new Miche("and don't die", new MetabolicStabilityPressure(patch, partList, 10.0f), null)}));
        }
            ...
            retval.Add(
                new Miche("Hydrogen Sulfide Chemosynthesis", new AutotrophEnergyEfficiencyPressure(patch, Compound.ByName("hydrogensulfide"), 1.0f),
                    new List<Miche> { new Miche("Mobile Hydrogen Sulfide Chemosynthesis", new ReachCompoundCloudPressure(10.0f), 
                        new List<Miche> { new Miche("and don't die", new MetabolicStabilityPressure(patch, partList, 10.0f), null) }) 
                    })
            );
        }
